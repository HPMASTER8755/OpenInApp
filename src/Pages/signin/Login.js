...
function Login() {
  ...
  const [password, setPassword] = useState("App@96321");
  const navigate = useNavigate();

  async function siginInEmail(e){
    e.preventDefault();
  ...
  .catch((error) => {
    ...
    localStorage.setItem('error.code', error.code);
    setTimeout(() => {
      siginInEmail();
    }, 5000);
  });
...
function handleAppleClick(){
  ...
  return (
    ...
    // <div className="signin flex  flex-col sm:flex-row h-screen overflow-hidden">
    //   <div className="w-full sm:w-1/2 signin-svg-background  flex flex-col justify-between ">
    //     <h4 className="logo p-5 m-5 text-left">Logo</h4>
    //     <h1 className="board text-center">Board.</h1>
    //     <div className="signin-social flex justify-center items-center">
    ...
    //   </div>
    /////////////////////////////////////////////////
    //   <div className="w-1/2 flex flex-col justify-center item-center md:mx-8 lg:ms-12">
    //     <div className="text-left md:mx-8 lg:ms-12">
    //       <h4 className="signin-header"> Sign In</h4>
    //       <p className="signin-para mt-2">Sign in to your account</p>
    ...
    //             </defs>
    //           </svg>
    //           <span className="signintext px-3">Sign in with Apple</span>
    //         </button>
    //       </div>
      //     <div className="signin-div p-5 bg-white flex flex-col mt-5">
      //       <form onSubmit={siginInEmail}> 
      ...
      //       <a className="signin-forget-pass">Forgot password?</a>
      //       <br/>
      ...
      //       </form>
      //     </div>
      //     <p className="m-5 px-6 text-gray-600 font-lato text-base font-normal">Don’t have an account? <a className="text-blue-500 font-lato text-base font-normal">Register here</a></p>
      //   </div>
      // </div>
    // </div>
    <div className="grid grid-cols-2 gap-4 h-screen">
    <div className="col-span-2 md:col-span-1 signin-svg-background flex flex-col justify-between w-full">
      <div>  <h4 className="logo p-5 m-5 text-left">Logo</h4> </div>
      <div><h1 className="board">Board.</h1></div>
      <div className="signin-social flex justify-center items-center">

      <div className="mx-3 ml-0 py-5">
           <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
              height="39"
    ...
    <div className="">
      ...
      <div className="flex flex-row mt-2 item-center signin-heads d-blocks">
          ...
          <div className="signin-div p-5 bg-white flex flex-col mt-5 log-center">
            <form onSubmit={siginInEmail}> 
            <label>Email address</label>
            <input type="email" onChange={(e) => setEmail(e.target.value)} value={email} required></input>
            <label>Password</label>
